                        ...
                        <form onSubmit={handleOtpSubmit}>
                            <div className="flex flex-col space-y-16">
                                ...
                                <div className="flex flex-col space-y-5">
                                    <div>
                                        <button type='submit' className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-[#3A244A] border-none text-white text-sm shadow-sm">
                                            Verify Account
                                        </button>
                                    </div>
